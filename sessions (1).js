...
const SESSIONS = [
  ...
  { id: 4,  title_fr: "Séance 4",  title_en: "Session 4",  title_it: "Sessione 4",
    subjects: { coran: { title_fr: "Voyelles longues", title_en: "Long vowels", title_it: "Vocali lunghe", engine: null },
  ...
  { id: 5,  title_fr: "Séance 5",  title_en: "Session 5",  title_it: "Sessione 5",
    subjects: { coran: { title_fr: "Soukoun", title_en: "Sukun", title_it: "Sukun", engine: null },
      athkars: { title_fr: null, engine: null }, fiqh: { title_fr: null, engine: null },
      exercices: { engine: "content-checklist" }, evaluation: { engine: "content-checklist" } } },
  { id: 6,  title_fr: "Séance 6",  title_en: "Session 6",  title_it: "Sessione 6",
    subjects: { coran: { title_fr: "Chadda", title_en: "Shadda", title_it: "Shadda", engine: null },
      athkars: { title_fr: null, engine: null }, fiqh: { title_fr: null, engine: null },
      exercices: { engine: "content-checklist" }, evaluation: { engine: "content-checklist" } } },
  { id: 7,  title_fr: "Séance 7",  title_en: "Session 7",  title_it: "Sessione 7",
    subjects: { coran: { title_fr: "Lecture des syllabes", title_en: "Reading syllables", title_it: "Lettura delle sillabe", engine: null },
      athkars: { title_fr: null, engine: null }, fiqh: { title_fr: null, engine: null },
      exercices: { engine: "content-checklist" }, evaluation: { engine: "content-checklist" } } },
  { id: 8,  title_fr: "Séance 8",  title_en: "Session 8",  title_it: "Sessione 8",
    subjects: { coran: { title_fr: "Lecture des mots simples", title_en: "Reading simple words", title_it: "Lettura di parole semplici", engine: null },
      athkars: { title_fr: null, engine: null }, fiqh: { title_fr: null, engine: null },
      exercices: { engine: "content-checklist" }, evaluation: { engine: "content-checklist" } } },
  { id: 9,  title_fr: "Séance 9",  title_en: "Session 9",  title_it: "Sessione 9",
    subjects: { coran: { title_fr: "Lecture des phrases", title_en: "Reading sentences", title_it: "Lettura delle frasi", engine: null },
      athkars: { title_fr: null, engine: null }, fiqh: { title_fr: null, engine: null },
      exercices: { engine: "content-checklist" }, evaluation: { engine: "content-checklist" } } },
  { id: 10, title_fr: "Séance 10", title_en: "Session 10", title_it: "Sessione 10",
    subjects: { coran: { title_fr: "Révisions générales", title_en: "General review", title_it: "Revisione generale", engine: null },
      athkars: { title_fr: null, engine: null }, fiqh: { title_fr: null, engine: null },
      exercices: { engine: "content-checklist" }, evaluation: { engine: "content-checklist" } } },
  { id: 11, title_fr: "Séance 11", title_en: "Session 11", title_it: "Sessione 11",
    subjects: { coran: { title_fr: "Introduction au Tajwid", title_en: "Introduction to Tajwid", title_it: "Introduzione al Tajwid", engine: null },
      athkars: { title_fr: null, engine: null }, fiqh: { title_fr: null, engine: null },
      exercices: { engine: "content-checklist" }, evaluation: { engine: "content-checklist" } } },
  { id: 12, title_fr: "Séance 12", title_en: "Session 12", title_it: "Sessione 12",
    subjects: { coran: { title_fr: "Lecture des sourates courtes", title_en: "Reading short surahs", title_it: "Lettura delle sure brevi", engine: null },
      athkars: { title_fr: null, engine: null }, fiqh: { title_fr: null, engine: null },
      exercices: { engine: "content-checklist" }, evaluation: { engine: "content-checklist" } } },
  { id: 13, title_fr: "Séance 13", title_en: "Session 13", title_it: "Sessione 13",
    subjects: { coran: { title_fr: "Lecture fluide dans le Moushaf", title_en: "Fluent reading in the Mushaf", title_it: "Lettura fluente nel Mushaf", engine: null },
      athkars: { title_fr: null, engine: null }, fiqh: { title_fr: null, engine: null },
      exercices: { engine: "content-checklist" }, evaluation: { engine: "content-checklist" } } },
];
