...
// -----------------------------------------------------------------------
// HARAKAT : les 3 voyelles courtes de base (Fatha, Damma, Kasra), chacune
// illustrée appliquée sur la lettre ب (Bā) pour former une syllabe
// audible — une harakat isolée n'a pas de son propre, elle doit toujours
// être montrée/entendue posée sur une lettre, exactement comme on
// l'enseigne en cours. Réutilisé par l'onglet Coran de la Séance 2
// (moteur "harakat-combo", même principe que "letters-combo" en Séance 1 :
// reconnaissance + prononciation).
// -----------------------------------------------------------------------
const HARAKAT = [
  { id: "fatha", char: "بَ", name_fr: "Fatha", name_en: "Fatha", name_it: "Fatha", translit: "a" },
  { id: "damma", char: "بُ", name_fr: "Damma", name_en: "Damma", name_it: "Damma", translit: "u" },
  { id: "kasra", char: "بِ", name_fr: "Kasra", name_en: "Kasra", name_it: "Kasra", translit: "i" },
];
...
function audioSourcesForHarakat(harakatId) {
  return ["mp3", "m4a", "wav", "ogg"].map((ext) => `audio_harakat_${harakatId}.${ext}`);
}
...
const SESSIONS = [
  ...
  { id: 4,  title_fr: "Séance 4",  title_en: "Session 4",  title_it: "Sessione 4",
    subjects: { coran: { title_fr: "Voyelles longues", title_en: "Long vowels", title_it: "Vocali lunghe", engine: "content-checklist" },
  ...
  { id: 5,  title_fr: "Séance 5",  title_en: "Session 5",  title_it: "Sessione 5",
    subjects: { coran: { title_fr: "Soukoun", title_en: "Sukun", title_it: "Sukun", engine: "content-checklist" },
      athkars: { title_fr: null, engine: null }, fiqh: { title_fr: null, engine: null },
      exercices: { engine: "content-checklist" }, evaluation: { engine: "content-checklist" } } },
  { id: 6,  title_fr: "Séance 6",  title_en: "Session 6",  title_it: "Sessione 6",
    subjects: { coran: { title_fr: "Chadda", title_en: "Shadda", title_it: "Shadda", engine: "content-checklist" },
      athkars: { title_fr: null, engine: null }, fiqh: { title_fr: null, engine: null },
      exercices: { engine: "content-checklist" }, evaluation: { engine: "content-checklist" } } },
