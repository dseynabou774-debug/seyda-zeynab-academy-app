  ...
  if (subject.engine === "content-checklist") {
    ...
    return `
      <div class="card subject-card">
        ...
        <p class="subject-note">${usable ? t("subjectLiveNote") : t("subjectToDefineNote")}</p>
        <button class="btn ${done ? "secondary" : "gold"} block" id="markDoneBtn" ${!usable ? "disabled" : ""}>
