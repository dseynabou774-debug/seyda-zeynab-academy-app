...
function defaultDiscoverContent() {
  return {
    ...
    scheduleSlots: {
      ...
      ar: [{ label: "من الإثنين إلى الأحد، بين الساعة 8 صباحًا و9 مساءً", available: true }, { label: "يُحدَّد اليوم والوقت الدقيقان مع المعلمة بعد التسجيل، حسب التوفر.", available: true }],
    },
    faq: {
      fr: [
...
const DISCOVER_LABELS = {
  ...
  ar: {
    ...
    registrationSent: "تم إرسال الطلب!", registrationSentMsg: "للتأكد من وصول طلبكم إلى الأكاديمية، يرجى التأكيد عبر زر واتساب أدناه.",
